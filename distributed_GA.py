...
parser.add_argument('--bindings', default='/opt/slurm,/asr/users/oswaldo_ludwig,/mnt,/opt/slurm,/var/run/munge,/asr/build', help="Container bindings")
parser.add_argument('--container', default='./container_for_w2v.sif', help="Path to Container")
...
parser.add_argument('--data', default="./paper_abstract_TTS.hrl", help="The training data")
parser.add_argument('--soundDir', default="./wav_files_paper_abstract/", help="Path to sound files directory")
