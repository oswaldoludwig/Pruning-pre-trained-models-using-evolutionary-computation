...
<p align="justify"> The <strong>run_distributed_GA.sh</strong>strong> script shows how to call the <strong>distributed_GA.py</strong>strong> master script that runs GA and automatically generates and calls the <strong>population_eval.sh</strong>strong> Shell script that contains the commands to parallelize GA population evaluation on a computer grid. </p>
