...
The **run_distributed_GA.sh** script shows how to call the **distributed_GA.py** master script that runs GA and automatically generate and call the **population_eval.sh** Shell script that contains the commands to parallelize GA population evaluation on a computer grid.
...
![alt tag](https://github.com/oswaldoludwig/Pruning-pre-trained models-using-evolutionary-computation/blob/master/pseudo_code.jpg)
